...
try:
    ...
    user1 = User(first_name="Ali", last_name="Khalilabadi", email="ali@sfbu", role="customer", password="aliali")
    user2 = User(first_name="Danny", last_name="Tarafa", email="danny@sfbu", role="customer",password="dannydanny")
    ...
    session.add_all([account11, account21])
